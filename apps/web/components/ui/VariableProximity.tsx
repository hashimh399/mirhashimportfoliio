...
// 1. Explicitly define the props so parent components (like ExploreSection) can read them
...
// 2. Pass the interface into the forwardRef so TypeScript knows exactly what to expect
